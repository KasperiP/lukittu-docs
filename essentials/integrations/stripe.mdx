...
Search webhooks on your Stripe dashboard search and create a new event destination. Set the endpoint URL to [**https://app.lukittu.com/api/v1/integrations/stripe?teamId=YOUR\_TEAM\_ID**](https://app.lukittu.com/api/v1/integrations/stripe?teamId=YOUR_TEAM_ID) **where YOUR\_TEAM\_ID is your Lukittu team's id. You can find that on Lukittu dashboard team => settings page.**